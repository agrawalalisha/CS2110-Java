...
public class VisualizeTour {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("Type the name of the file you wish to use: (i.e.: tsp5.txt)");
        ...
        try {
            ...
            // draw to standard draw
            drawTour(tour, null);
            msgr(-1 / 20.0, "No more Points in file " + filename);
    ...
    public static void drawTour(Tour tour, Coordinate p) {
        PennDraw.clear();
